...
import static io.parsingdata.metal.Shorthand.range;
...
public class RangeTest {
    ...
    @Test
    public void terminatedStrings() throws IOException {
        ...
        final Optional<Environment> environment =
            rep(
                range(
                    "size",
                    seq(def("line", last(ref("size"))),
                        def("newline", con(1), eq(con(10)))),
                    con(100))
